...
DetailScreen2Page = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
        selector: 'page-detail-screen2',template:/*ion-inline-start:"C:\Users\ranandan\Documents\Sample.git\apiApp\src\pages\detail-screens\detail-screen2\detail-screen2.html"*/'\n<ion-header>\n  <ion-navbar>\n    <ion-title>detail-screen2</ion-title>\n  </ion-navbar>\n\n</ion-header>\n  <ion-content class="app-bg">\n<ion-slides pager>\n\n  <ion-slide *ngFor="let item of navParams.data.detail_trends; let i = index">\n    <h2>Slide</h2>\n      <button ion-button block (click)="goToPrevSlide()">Navigate Back</button>\n        <h2>{{item[0].detail}}</h2>\n        <h2>{{item[0].name}}</h2>\n        <h2>{{item[0].template}}</h2>\n      <button ion-button block (click)="goToNextSlide()">Navigate Forward</button>\n  </ion-slide>\n</ion-slides>\n  </ion-content>\n'/*ion-inline-end:"C:\Users\ranandan\Documents\Sample.git\apiApp\src\pages\detail-screens\detail-screen2\detail-screen2.html"*/,
    }),
